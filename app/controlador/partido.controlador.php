...
class PartidoControlador{
    ...
    public function Guardar(){
        if (isset($_POST['arbitro1'], $_POST['arbitro2'], $_POST['arbitro3'], $_POST['arbitro4'], 
        $_POST['equipo1'], $_POST['id'],$_POST['equipo2'],$_POST['torneo'],$_POST['estadio'],$_POST['estado'],
        $_POST['fecha'],$_POST['temporada'],$_POST['equipo_ganador'],$_POST['marcador'])) {
            $p = new Partidos();
